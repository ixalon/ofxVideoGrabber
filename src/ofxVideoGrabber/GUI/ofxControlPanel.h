...
class ofxControlPanel: public guiBaseObject{
	...
	public:
        ...
        guiTypeButtonSlider * addButtonSlider(string sliderName, string xmlName, float value , float min, float max, bool isInt,  BaseCallback* pCallback, int _callback_id);
        guiTypeTextDropDown * addTextDropDown(string name, string xmlName, int defaultBox, vector <string> boxNames, BaseCallback* pCallback, int _callback_id );
